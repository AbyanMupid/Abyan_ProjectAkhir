    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('index')}}">
                ...
                <div class="sidebar-brand-text mx-3">PEMBAYARAN SPP <sup>BEK KA</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{url('siswa')}}" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="{{url('tambahpetugas')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
